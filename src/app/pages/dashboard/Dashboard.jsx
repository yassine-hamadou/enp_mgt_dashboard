...
function OverView() {
    ...
    function pieTemplate() {
        return (<div className="template">
            <AccumulationChartComponent style={{ "height": "100%", "width": "100%" }} legendSettings={{ visible: false }} load={accumulationload.bind(this)} tooltip={{ enable: true, format: "${point.tooltip}" }} pointRender={onPointRender.bind(this)} enableSmartLabels={true} enableBorderOnMouseMove={false}>
        ...
        <div className="control-section">
            ...
            <DashboardLayoutComponent cellSpacing={cellSpacing} cellAspectRatio={Browser.isDevice ? 1 : 0.8} columns={Browser.isDevice ? 2 : 8}>
                ...
                <PanelsDirective>
                    ...
                    <PanelDirective sizeX={Browser.isDevice ? 1 : 3} sizeY={Browser.isDevice ? 1 : 2} row={0} col={Browser.isDevice ? 1 : 5} content={pieTemplate.bind(this)} header='<div  class="title" id="header2";>Product Wise Sales - 2021</div>'></PanelDirective>
                    <PanelDirective sizeX={Browser.isDevice ? 2 : 8} sizeY={Browser.isDevice ? 1 : 3} row={Browser.isDevice ? 1 : 4} col={0} content={splineTemplate.bind(this)} header='<div  class="title" id="header3";>Monthly Sales for 2021</div>'></PanelDirective>
                </PanelsDirective>
