...
const DashboardTable = () => {
  ...
  const getEquipmentManufacturer = (manufacturerId: any) => {
    const manufacturer = listOfequipmentManufacturer?.data?.find(
      (manufacturer: any) => manufacturer.manufacturerId === manufacturerId
    )
  ...
  const countNumberOfDownTime = (modelId: any) => {
    ...
    //@ts-ignore
    const modelName = queryClient
      .getQueryData('listOfEquipmentModel')
      ?.data?.find((model: any) => model.modelId == modelId).name
